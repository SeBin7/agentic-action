...
export function loadEnv({ env = process.env } = {}) {
  ...
  return {
    ...
    runtimeDbPath: merged.RUNTIME_DB_PATH || merged.DB_PATH,
    logPath: merged.LOG_PATH,
    apiHost: merged.API_HOST,
    apiPort: toNumber(merged.API_PORT, 8787),
    apiReadOnly: toBoolean(merged.API_READ_ONLY, true),
